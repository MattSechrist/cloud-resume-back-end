# This Terraform files is depracated as I switched from a GET request REST API for the Visitor Counter , over to using a POST request REST API in front of an AppSync/GraphQL endpoint.
